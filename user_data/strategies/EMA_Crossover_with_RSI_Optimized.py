...
class EMA_Crossover_with_RSI_Optimized(IStrategy):
    """
    ...
    # ------ Settings if there is no config
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # dataframe.loc[
        #     (
        #         (qtpylib.crossed_above(dataframe['rsi'], self.sell_rsi)) &  # Signal: RSI crosses above sell_rsi
